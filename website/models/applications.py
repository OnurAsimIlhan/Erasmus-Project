...
class Applications(db.Model):
    ...
    application_form = db.Column(db.LargeBinary, nullable=True)
    pre_approval_form = db.Column(db.LargeBinary, nullable=True)
    learning_agreement_form = db.Column(db.LargeBinary, nullable=True)
    final_transfer_form = db.Column(db.LargeBinary, nullable=True)
