...
class ErasmusCoordinatorApplications(MethodView, AuthorizeService):
    def __init__(self, role: str, user_service, applications_service, university_service):
    ...
    def post(self):
        if AuthorizeService.is_authorized(self): 
            ...
            if "approve" in request.form:
                ...
                return render_template("erasmus_coordinator_applications.html", user = current_user, university_dictionary=university_dictionary, user_service=self.user_service, applications_service=self.applications_service)
